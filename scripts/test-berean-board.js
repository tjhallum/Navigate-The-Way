...
test('renders group setup wizard controls before lesson setup in the browser form', () => {
  ...
  assert.match(html, /<link rel="stylesheet" href="styles\.css\?v=20260620-icon-host-overrides" \/>/);
  ...
  assert.match(html, /<script src="berean-board\.js\?v=20260620-icon-host-overrides"><\/script>/);
